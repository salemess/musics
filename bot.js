...
client.user.setGame(`s!play | lacamor Music`,"http://twitch.tv/Death Shop")
...
client.on('ready', () => { //code bot not leave room voice //Bot Is Online
    client.channels.get("511592180716929045").join(); //by : iBeAnthonyD
    })
	
		client.on('message', msg => {
  if (msg.content === 's!inv') {
    msg.reply('https://discordapp.com/api/oauth2/authorize?client_id=510158434952282146&permissions=8&scope=bot');
  }
});
